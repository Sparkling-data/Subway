...
def chart():
    ...
    m.plot(forecast, xlabel= 'Date', ylabel='passengers')
    plt.savefig('./static/images/chart03.png')
    ...
    # 2021 05 데이터 정제
    # df = pd.read_csv("./dataset/CARD_SUBWAY_MONTH_202105.csv")
    ...
    # # 201905 데이터정제
    # df1 = pd.read_csv("./dataset/CARD_SUBWAY_MONTH_201905.csv", encoding='cp949')
    ...
    # plt.savefig('./static/images/chart04.png')
